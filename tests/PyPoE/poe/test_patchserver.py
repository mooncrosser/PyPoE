...
class TestPatchFileList:
    ...
    @pytest.mark.dependency(
        name="test_updatelist", depends="TestPatchFileList::test_init"
    )
    @pytest.mark.parametrize(
        "node_path", [_TEST_FILE] + _TEST_NODE_PATHS + [_TEST_FILE]
    )
...
@pytest.mark.dependency(
    name="test_node_outdated_files", depends=["test_node_check_hash"]
)
@pytest.mark.parametrize(
    "recurse,node_path",
    [
